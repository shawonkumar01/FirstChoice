...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\FirstChoice\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\FirstChoice\\public\\storage','logging.default','logging.deprecations.channel',
...
'livewire.update','livewire.upload-file','livewire.preview-file','dashboard','profile','register',
'login','password.request','password.reset','verification.notice','verification.verify',
'password.confirm','storage.local',);
        registerArgumentsSet('views', 
'admin.home','components.action-message','components.application-logo','components.auth-session-status','components.danger-button',
